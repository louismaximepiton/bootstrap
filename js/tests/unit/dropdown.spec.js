...
describe('Dropdown', () => {
  ...
  describe('data-api', () => {
    ...
    it('should manage bs attribute `data-bs-popper`="none" when dropdown is in navbar', done => {
      ...
      btnDropdown.addEventListener('shown.bs.dropdown', () => {
        expect(dropdownMenu.getAttribute('data-bs-popper')).toBe('none')
        dropdown.hide()
      })
    ...
    it('should manage bs attribute `data-bs-popper`="static" when display set to static', done => {
      ...
      btnDropdown.addEventListener('shown.bs.dropdown', () => {
        expect(dropdownMenu.getAttribute('data-bs-popper')).toBe('static')
        dropdown.hide()
      })
    ...
    it('should skip disabled element when using keyboard navigation', done => {
      ...
      triggerDropdown.addEventListener('shown.bs.dropdown', () => {
        ...
        expect(document.activeElement.classList.contains('disabled')).toBeFalse()
    ...
    it('should skip hidden element when using keyboard navigation', done => {
      ...
      triggerDropdown.addEventListener('shown.bs.dropdown', () => {
        ...
        expect(document.activeElement.classList.contains('d-none')).toBeFalse()
  ...
  describe('getOrCreateInstance', () => {
    ...
    it('should return new instance when there is no dropdown instance with given configuration', () => {
      ...
      expect(dropdown._config.display).toBe('dynamic')
    })
    ...
    it('should return the instance when exists without given configuration', () => {
      ...
      expect(dropdown2._config.display).toBe('dynamic')
    })
  })
